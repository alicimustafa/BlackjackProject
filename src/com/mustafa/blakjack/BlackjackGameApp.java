...
public class BlackjackGameApp {
	...
	/**
	 * @param numDecks number of decks to be generated
	 * this is the constructor for the main app it 
	 * fill the dealer shoe with card and suffles it
	 */
	...
	/**
	 * @param playerNum number players vs the dealer
	 * @param keyboard 
	...
	/**
	 * this draws the ascii art for all of the player
	 * and dealer representing cards
	 * 
	 */
	...
	/**
	 * @param player plaer being compared
